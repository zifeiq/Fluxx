...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Waiting_t, stringdata) + ofs \
...
const QMetaObject Waiting::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_Waiting.data,
      qt_meta_data_Waiting,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Waiting.stringdata))
